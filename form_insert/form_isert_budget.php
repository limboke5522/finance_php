...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="insert_budget.php" id="formUser" method="post" enctype="multipart/form-data">
				<span class="contact100-form-title">
					ADD BUDGET
				</span>

				<div class="wrap-input100 validate-input bg1" data-validate="Please Type Your NameBudget">
                ...
                <div>
                    <br>
                    <br>
                    <p ><a href="../index.php?action=budget" >ย้อนกลับ</a></p>
               </div>
			</form>
		</div>
	</div>
